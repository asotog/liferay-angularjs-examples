...
public class FourthLearningPortlet extends MVCPortlet {
    ...
    public void serveResource(ResourceRequest resourceRequest,
        ...
        for (AssetCategory assetCategory : categories) {
            ...
            cat.put("id", assetCategory.getCategoryId());
    ...
    private static final Log _log = LogFactoryUtil.getLog(FourthLearningPortlet.class);
}
